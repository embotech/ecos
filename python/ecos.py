...
def solve(c,G,h,dims,A=None,b=None, opts={}):
    ...
    if A is None:
        ...
        return _ecos.csolve((m,n1,p), c, data, indices, colptr, h, dims,opts=opts)
    else:
        return _ecos.csolve((m,n1,p), c, data, indices, colptr, h, dims, A.data, A.indices, A.indptr, b, opts)
